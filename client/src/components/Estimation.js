    ...
    useEffect(() =>{
        async function onGetEstimate(){
           console.log(`making api call: ${temperature}, ${holiday}, ${season} `)
            let response =  await fetch(`https://bike-rental-estimation-api.herokuapp.com/api/getEstimate`, {
                method: 'POST',
                headers: {
            ...
            let opposite_response =  await fetch(`https://bike-rental-estimation-api.herokuapp.com/api/getEstimate`, {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json'
                },
